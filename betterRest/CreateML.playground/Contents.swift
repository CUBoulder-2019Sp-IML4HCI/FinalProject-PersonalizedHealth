...
let data = try MLDataTable(contentsOf: URL(fileURLWithPath: "/Users/akshitarora/Documents/GitHub/courses/ml_hci/better-rest.json"))
...
try regressor.write(to: URL(fileURLWithPath: "/Users/akshitarora/Documents/GitHub/courses/ml_hci/SleepCalculator.mlmodel"), metadata: metadata)
